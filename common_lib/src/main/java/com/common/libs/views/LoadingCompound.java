		...
		if (!isInEditMode()) {
			...
			if (attrs != null) {
				...
				int loadingMessageColor = a.getColor(
						R.styleable.common_loadingMessageColor, context
								.getResources().getColor(R.color.DarkGray));
				int errTitleColor = a.getColor(
						R.styleable.common_loadingErrorTitleColor, context
								.getResources().getColor(R.color.Black));
				int errMessageColor = a.getColor(
						R.styleable.common_loadingErrorMessageColor,
				...
				String loadingMessage = a.getString(R.styleable.common_loadingMessage);
				if (loadingMessage != null) {
					tvLoading.setText(loadingMessage);
				}

				String retryButtonText = a.getString(R.styleable.common_loadingRetryButtonText);
				if (retryButtonText != null) {
					btnRetry.setText(retryButtonText);
				}

				boolean useNilaGif = a.getBoolean(R.styleable.common_loadingGifNila, false);
				if(useNilaGif){
//					Glide.with(context)
//							.asGif()
...
//					tvLoading.setVisibility(View.GONE);
				...
				noNetworkMessage = a.getString(R.styleable.common_loadingErrorNetworkTitle);
				unknownResponseMessage = a.getString(R.styleable.common_loadingErrorUnknownResponseMessage);
				noInternetMessage = a.getString(R.styleable.common_loadingErrorNoInternetMessage);

				if (noNetworkMessage == null) {
					noNetworkMessage = getContext().getString(R.string.common__network_error);
				}

				if (noInternetMessage == null) {
					noInternetMessage = getContext().getString(R.string.common__no_internet);
				}

				if (unknownResponseMessage == null) {
					unknownResponseMessage = getContext().getString(R.string.common__unknown_response);
				}
